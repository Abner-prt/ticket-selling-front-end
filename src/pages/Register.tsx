        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex flex-col items-center mb-8">
              ...
              <h2 className="text-3xl font-black text-slate-900 tracking-tight mb-2">Crea tu cuenta</h2>
              <p className="text-slate-500 font-medium">Únete a ALABAN TICKETS hoy mismo</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-slate-700 font-semibold mb-2 ml-1 text-sm">Nombre</label>
                ...
                <div>
                  <label className="block text-slate-700 font-semibold mb-2 ml-1 text-sm">Apellido</label>
                  <div className="relative">
                    <input
                      type="text"
                      required
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-2 ml-1 text-sm">Correo electrónico</label>
                <div className="relative">
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-2 ml-1 text-sm">Contraseña</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
