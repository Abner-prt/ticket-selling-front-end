...
export const EventsCatalog = () => {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        const response = await apiClient.get<ResponseDto<EventDto[]>>('/events');
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full pl-10 pr-4 py-2 border border-slate-300 rounded-md focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-all"
                  />
              ...
              <div>
                ...
                <div className="space-y-2">
                  {['Todos', 'Conciertos', 'Teatro', 'Deportes'].map((cat) => (
